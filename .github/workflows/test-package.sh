...
docker run ${DOCKER_RUN_PARAMS} \
    ...
    -e INPUT_BUILD_COMMAND='conan profile detect -f && conan create /github/workspace/external/context-core-api --build=missing -s compiler.cppstd=17 && conan create /github/workspace/' \
